...
from graph_algorithms.kruskal import kruskal_algorithm
import random
import time
import numpy as np
...
if __name__ == "__main__":
    ...
    kruskal_vertices_list = kruskal_algorithm().kruskal(random_graph.edges, list(random_graph.vertices.keys()),1)
    ...
    kruskal_vertices_list = kruskal_algorithm().kruskal(graph.edges, list(graph.vertices.keys()), clusters=5)
    ...
    plotly_visualization(graph, edges_list=kruskal_vertices_list[0])